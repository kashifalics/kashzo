...
export const metadata: Metadata = { title: 'Work | Kashzo Solutions', description: 'Explore verified AI, web and mobile systems delivered by Kashzo for real business environments.' };

export default function WorkPage(){return <main className={styles.page}>
  <section className={styles.hero}><div className={`${styles.shell} ${styles.heroInner}`}><Reveal><p className={styles.eyebrow}>Selected work</p><h1>Real systems. Real business use.</h1><p className={styles.heroCopy}>A selection of AI, automation, web and mobile work designed around operations, growth and customer experience.</p></Reveal><Reveal delay={.12} className={styles.heroAside}><strong>Verified portfolio</strong><p>No invented metrics or speculative concepts—only project experience represented in the Kashzo portfolio.</p></Reveal></div></section>
  <section className={`${styles.section} ${styles.soft}`}><div className={styles.shell}><Reveal><p className={styles.label}>Case studies</p><h2 className={styles.heading}>Delivery across systems and sectors.</h2><p className={styles.lede}>Filter the portfolio by core delivery discipline, then open a case study for the challenge, solution and architecture.</p></Reveal><div style={{marginTop:'48px'}}><WorkGrid projects={projects}/></div></div></section>
