...
export const metadata: Metadata = { title: 'Contact | Start a Project with Kashzo', description: 'Tell Kashzo about your AI, software, mobile or growth requirement and start a practical discovery conversation.', alternates: { canonical: '/contact' } };
